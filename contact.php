...
<div class="nav">
      ...
      <header style="background-image:url(images/pexels-chepté-cormani-1416530.jpg) ;height: 100vh;">
        <div id="contact" class="layer"></div>
      <nav>
      <h1>
contact us      </h1>
      <p style="font-size:30px ;text-transform: capitalize;">
we service you eny time      
      </p>
        ...
        <div class="container-block form-wrapper">
          ...
          <div class="responsive-container-block" id="i2cbk">
            <div class="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-12 wk-ipadp-12" id="i10mt-3">
              ...
              <input class="input _name" id="ijowk-3" name="FirstName" placeholder="Please enter first name...">
            </div>
            <div class="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-12 wk-ipadp-12" id="ip1yp">
                <p class="text-blk input-title">
                EMAIL
              </p>
              <input class="input _email" id="ipmgh-3" name="Email" placeholder="Please enter email...">
            </div>
            <div class="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-12 wk-ipadp-12" id="ih9wi">
                <p class="text-blk input-title">
                    PHONE NUMBER
                </p>
                <input class="input _number" id="imgis-3" name="PhoneNumber" placeholder="Please enter phone number...">
            </div>
            <div class="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-12 wk-ipadp-12" id="i634i-3">
              <p class="text-blk input-title">
                WHAT DO YOU HAVE IN MIND ?
              </p>
              <textarea class="textinput _msg" id="i5vyy-3" placeholder="Please enter query..."></textarea>
            </div>
        </div>
          ...
          $(function(){
            ...
            $(".form-box").submit(function(e){
             ...
             if(name && email && number && msg ){
              ...
              $.post("admin/functions/insert_msg.php",{
              ...
              $(".msg").html("msg not sent pleese enter all data").addClass("alert alert-danger ");
            }
